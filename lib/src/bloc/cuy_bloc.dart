...
class CuyBloc {
  ...
  Stream<List<ContenedorModel>> get contenedoresStream =>
      _contenedoresController.stream;
  ...
  void cargarCrias(List<CuyModel> lista) async {
    _cuyController.value.addAll(lista);
    _cuyController.sink.add(_cuyController.value);
  }
